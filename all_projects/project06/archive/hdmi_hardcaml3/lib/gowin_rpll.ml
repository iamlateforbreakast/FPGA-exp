...
let parameters = 
  ...
  [
    ...
    "DYN_IDIV_SEL", Parameter.Value.String "false";  (* Dynamic Input Divider Selection *)
    "IDIV_SEL", Parameter.Value.Int 3;   (* Input Clock Divider *)
    "DYN_FBDIV_SEL", Parameter.Value.String "false";  (* Dynamic Feedback Divider Selection *)
    "FBDIV_SEL", Parameter.Value.Int 54;  (* Feedback Clock Divider *)
    "DYN_ODIV_SEL", Parameter.Value.String "false";  (* Dynamic Output Divider Selection *)  
    "ODIV_SEL", Parameter.Value.Int 2;   (* Output Clock Divider *)
    "PSDA_SEL", Parameter.Value.String "0000";   (* Phase Shift Selection *)
    "DYN_DA_EN", Parameter.Value.String "true";  (* Dynamic Phase Shift Enable *)
    "DUTYDA_SEL", Parameter.Value.String "0000"; (* Duty Cycle Correction Selection *)
    "CLKOUT_FT_DIR", Parameter.Value.Int 0b1;  (* CLKOUT Falling Edge Direction *)
    "CLKOUTP_FT_DIR", Parameter.Value.Int 0b1; (* CLKOUTP Falling Edge Direction *)
    ...
    "CLKOUT_BYPASS", Parameter.Value.String "false";  (* CLKOUT Bypass *)
    "CLKOUTP_BYPASS", Parameter.Value.String "false"; (* CLKOUTP Bypass *)
    "CLKOUTD_BYPASS", Parameter.Value.String "false"; (* CLKOUTD BYpass *)
